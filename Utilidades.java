...
/**
 * Clase Utilidades.
 * En esta clase se definen métodos estáticos para desplegar los distintos menus del sistema entre otras utilidades.
 * @version 07/12/2023
...
public class Utilidades {
    ...
    /**
     * Este método imprime el menu de distintas acciones que puede realizar un cliente en el sistema.
     * @param cliente El cliente que interactua con el menu.
     */
    ...
    /**
     * Método que imprime los datos ingresados por un usuario antes de realizar un registro, sirve para la confirmación de datos por parte del usuario.
     * @param nombre El nombre ingresado.
     * @param apellidoPaterno El apellido paterno ingresado.
     * @param apellidoMaterno El apellido materno ingresado.
     * @param edad La edad ingresada.
     * @param correo El correo ingresado.
     * @param numeroCelular El número celular ingresado.
     * @param direccion La dirección ingresada.
    ...
    /**
     * Imprime el menu de interacción para un administrador.
     * @param elAdmin El administrador que interactúa del menu.
     * @param losEmpleados La lista de empleados para realizar algún registro o para
     */
